      ...
      <div className="">
        <div className="flex gap-4 mt-1 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[67.5%]">
            ...
            {/* body */}
            <div className="pl-3 pr-2 pt-3 pb-5 bg-white rounded-b-lg shadow-md text-[11px]">
            ...
            <div className="w-full mx-auto bg-white rounded-lg flex flex-col items-center">
              ...
              <div className="flex justify-center w-full bg-[#f2f2f2]">
                ...
                >
                  <button
                    type="button"
                    className={`px-4  text-[12px] font-medium rounded-l-lg w-full ${
                      userType === "Staff"
                  ...
                  <button
                    type="button"
                    className={`px-4 py-2 text-[12px] font-medium rounded-r-lg w-full ${
                      userType === "Hub User"
                        ? "bg-white text-gray-900"
                        : "bg-[#f2f2f2] hover:bg-gray-200"
                    }`}
              ...
              {/* user section */}
              <div className=" h-[50px] w-full punctualityGradient">hfhf</div>
