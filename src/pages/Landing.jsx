  ...
  return (
    <div className="p-4 mx-auto container">
      ...
      <section className="mx-auto max-w-[634px] text-center mt-5 px-4">
        ...
        <Link
          to={"/home"}
          className="bg-[#FEDC44] border rounded-full w-full max-w-xs md:max-w-sm lg:max-w-[500px] mt-5 py-3 md:py-5 text-[#000000] font-semibold flex items-center justify-center gap-2 mx-auto"
        >
          Get In <FaArrowUp />
        </Link>
      </section>
